            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                           <div class="col-lg-12">
                               <div class="form-group pull-left"> 
                                   ...
                                   <?php echo '<a href="add_new_employee.php?menu_id='. $menu_id . '&action_id='. $action_id .'&add=True" class="btn btn-primary btn-sm" role="button">Add</a>';?>
                               </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h3><small>Personas</small></h3><br>
                                <div class="table-responsive">
									<?php get_all_employee($connection, $menu_id, $action_id);?>
                                </div>
                            </div>
                            <!-- /.col-lg-12 -->
                        </div>
