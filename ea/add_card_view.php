                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group pull-left">  
                                    ...
                                    <?php
                                    if(!isset($_GET['edit'])){
                                        echo '<a href="?menu_id=' . $menu_id . '&action_id=' . $action_id . '&card_id=' . $card_id . '&edit=true" class="btn btn-warning btn-sm" role="button">Edit</a>';
                                    }
                                    else{
                                        echo '<button type="submit" class="btn btn-success btn-sm" name="submit" form="save_card">Save</button>';
                                    }
                                    ?>
									<button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal">Eliminar</button>
                                    
                                    <?php if($edit == 'true')
                                        echo '<a href="add_card_view.php?menu_id=' . $menu_id . '&action_id=' . $action_id . '&card_id=' . $card_id . '" class="btn btn-default btn-sm" role="button">Cancel</a>';
                                    ?>
								  ...
								  <div class="modal-dialog">
									<div class="modal-content">
									  ...
									  <div class="modal-body">
										<p>Desea Eliminar esta Tarjeta?</p>
									  </div>
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-lg-8 col-md-offset-2">
												...
												<?php echo '<strong>Alerta!</strong> Satisfactorio!';?>
												<?php echo '</div>';?>
												...
												<?php echo '<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>';?>
												<?php echo '<strong>Alerta!</strong> Algo Fallo!';?>
												<?php echo '</div>';?>
												<?php $_SESSION["edited"]=False; ?>
												<?php endif; ?>
                                                            ...
                                                            <div class="col-md-12">
                                                                <form action="save_card.php?menu_id=<?php echo $menu_id . '&action_id='. $action_id . '&card_id='.$card_id; ?>" method="POST" id="save_card"  class="form-horizontal" accept-charset="UTF-8">
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <fieldset>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label class="col-md-3 control-label" for="selectbasic">Tarjeta ID</label>
                                                                                    <div class="col-md-9">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <fieldset>
                                                                                <legend><h4>Configuracion</h4></legend>   
                                                                                <div class="form-group">
                                                                                    <label class="col-md-3 control-label" for="textinput">Empleado</label>  
                                                                                    <div class="col-md-9">
                                                                                ...
                                                                                <!-- Multiple Radios (inline) -->
                                                                                 <div class="form-group">
                                                                                    <label class="col-md-3 control-label" for="radios">Activo</label>
                                                                                    <div class="col-md-9"> 
                                                                                  ...
                                                                                  <!-- Textarea -->
                                                                                <div class="form-group">
                                                                                    <label class="col-md-3 control-label" for="textarea">Coment. </label>
                                                                                    <div class="col-md-9">                     
